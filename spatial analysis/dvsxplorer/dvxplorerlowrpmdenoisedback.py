...
testPath = "H:\\evs\\fixedSpinningWheel\\davisXplorer\\10rpm\\dvSave-2020_03_17_20_16_34denoisedEvents.npy"
...
xOffset = 6.5 #actually yOffset here
yOffset = -3 #inverted xOffset here
...
#rpm = 38.0 #1/4 lap avg rpm
#rpm = 38 #1/4 lap avg rpm
#rpm = 38.1
#rpm = 37.46 #1/8 lap
#rpm = 37.35
#rpm = 37.4 #1/4 lap avg rpm

#v2

#rpm = 37.3 #0.9601995166349565
rpm = 37.4 #0.9624964087604146
#rpm = 37.5 #0.9607805483337273

#rpm  = 37.7 #0.9536583919091259
#rpm = 38.1  # 0.9237655406770907
#rpm = 38.5 #0.8428196973931699
...
#place presets
#startIndex of events 2913
#startIndex = 1019913 #1  lap
#startIndex = 3263000
startIndex = 3264000

...
#rpm = 463  #0.4937809923015808
#rpm = 469 #0.5400563348060453
rpm = 470 #0.5422624538745388
#rpm = 471 #0.5422155732109399
#rpm = 473 #0.5371042995511458
...
startIndex = 27335000 #a point where it starts aligned

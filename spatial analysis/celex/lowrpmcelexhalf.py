...
testPath = "H:\\evs\\fixedSpinningWheel\\celex\\10rpm\\10rpmCelex.npy"
...
#pixelSpinner = 776 #radius in pixels, manually fixed
...
#centimeter = math.ceil(pixelSpinner/24.5);
...
#rpm = 38 #0.7842867545917954
#rpm = 37.3  #0.8393430541664474
#rpm = 37 #0.8548660562902679
#rpm = 36.9 #0.8590366769774636
rpm = 36.8 #0.8627938283110697
#rpm = 36.7 #0.8571354825387812
#rpm = 36.6 #0.8411366502792721

#rpm = 36.5 #0.8197662497436949

#rpm = 36 #0.697735477518871



#startBigFrontAngle = 2*np.pi-np.arccos(1/radiusDistCm)
startBigFrontAngle = np.arccos(2/radiusDistCm)

startSmallFrontAngle = 0
#place presets
#startIndex = 4045000 #other tihng
#startIndex = 5186300
startIndex = 5212000
#startTime = 4437903
